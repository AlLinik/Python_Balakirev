...
[print('Переменная a = ' + a + ', переменная b = ' + b) for a, b in [input().split()]]

print('Переменная a = {}, переменная b = {}'.format(*input().split()))

print((lambda a, b: "Переменная a = " + a + ", переменная b = " + b)(*input().split()))

a, b = input().split()
print(''.join(('Переменная a = ', a,', переменная b = ',b)))